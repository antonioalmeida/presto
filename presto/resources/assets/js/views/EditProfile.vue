						...
						<div class="row align-items-center">
							<div class="col-md-2 text-center ">
								...
								<span class="fa-layers fa-fw fa-2x">
									...
									<a><i class="fa-inverse fa-fw fas fa-pencil-alt text-muted" data-fa-transform="shrink-8"></i></a>
								</span>
							</div>
							...
							<div class="col-md-6 mobile-center text-shadow edit-profile">
									...
									<div class="mt-3">
										...
										<div class="ml-1 mt-3">
											...
											<router-link :to="'/profile/' + user.username" class="btn btn-danger">Cancel</router-link>
										</div>
