...
(function ($) {
    ...
    function TagsInput(element, options) {
        ...
        this.$container = $('<div class="bootstrap-tagsinput"><i class="far fa-tags text-primary"></i> </div>');
    ...
    TagsInput.prototype = {
        ...
        add: function (item, dontPushVal, options) {
            ...
            var $tag = $('<span class="badge ' + htmlEncode(tagClass) + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<span data-role="remove"><i class="far fa-times"></i></span></span>');
            $tag.data('item', item);
