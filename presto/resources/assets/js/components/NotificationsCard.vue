            ...
            <div>
                <template v-if="notification.data['type'] == 'Follow'">
                    <a :href="'/profile/' + notification.data['follower_username']" class="pb-1">
                        <img class="rounded-circle pr-1" width="36" height="36"
                             :src="notification.data['follower_picture']" :alt="notification.data['follower_name']+'\'s profile picture'">{{notification.data['follower_name']}}</a>
                ...
                <template v-if="notification.data['type'] == 'Question'">
                    <a :href="'/profile/' + notification.data['following_username']" class="pb-1">
                        <img class="rounded-circle pr-1" width="36" height="36"
                             :src="notification.data['following_picture']" :alt="notification.data['follower_name']+'\'s profile picture'">{{notification.data['following_name']}}</a>
