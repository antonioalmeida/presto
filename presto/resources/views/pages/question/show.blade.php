            ...
            <div class="row">
                <div class="offset-md-2 col-md-8">
                    ...
                    <div class="card my-3">
                        <div class="card-body">
                            <h6>
                                <small>{{$question->comments->count()}} Comments</small>
                            </h6>
                            <div id="questionComments" class="d-flex list-group list-group-flush short-padding">
                                ...
                                <a class="btn btn-lg btn-link text-dark" data-toggle="collapse"
                                   href="#commentCollapse{{ $question->id}}" role="button" aria-expanded="false"
                                   aria-controls="commentCollapse{{ $question->id}}">
                                    View More
                                </a>
                    ...
                    <div id="questionAcordion" class="mt-3">
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            <div>
                                <a id="headingAnswer" class="btn btn-primary" data-toggle="collapse" role="button"
                                   href="#answerCollapse" aria-expanded="false" aria-controls="answerCollapse">
                                    <i class="far fa-fw fa-pen"></i> Answer
                                </a>

                                <a id="headingComment" class="btn" data-toggle="collapse" href="#commentCollapse"
                        ...
                        <div id="answerCollapse" class="collapse mt-2 pb-2" aria-labelledby="headingAnswer"
                             data-parent="#questionAcordion">
                            ...
                            <form action="{{Route('answer-add', $question)}}" method="post">
                                <div class="card">
                                    ...
                                    <textarea class="has-mentions" contenteditable="true" name="content"
                        ...
                        <div id="commentCollapse" class="collapse mt-2 pb-2" aria-labelledby="headingComment"
                             data-parent="#questionAcordion">
                                ...
                                <div class="card">
                                    <div class="input-group">
                                        <textarea class="form-control" name="content"
                                                  placeholder="Leave a comment..."></textarea required>
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                        <button class="btn btn-sm btn-link">Cancel</button>
