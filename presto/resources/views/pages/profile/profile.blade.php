                ...
                <div class="col-md-6 text-shadow mobile-center">
                    ...
                    <div class="bio mt-3">
                        <div class="d-flex justify-content-sm-start justify-content-around">
                            <a href={{Route('followers', $member)}}>
                                <h5 class="p-2 h5-adapt">{{count($member->followers)}}
                                    <small>followers</small>
                                </h5>
                            </a>
                            <a href={{Route('following', $member)}}>
                                <h5 class="p-2 h5-adapt">{{count($member->followings)}}
