        ...
        <section class="container">
            ...
            <div class="list-group offset-md-3 col-md-7">
                ...
                @foreach($member->followers as $follower)
                    <div onclick="location.assign('{{Route('profile', $follower->username)}}');"
                        ...
                        <div class="d-flex w-100 justify-content-begin">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <h6 class="text-collapse">
                                    <small>{{ $follower->bio }}</small>
                                </h6>
                                <h6>
                                    <small class="text-muted"><i
                                                class="fas fa-gem text-primary"></i> {{$follower->score}} points
                                    </small>
                                </h6>
                            </div>

                            <div class="ml-auto align-self-center flex-wrap">
                                @include('partials.follow', ['followTarget' => $follower])
                            </div>
