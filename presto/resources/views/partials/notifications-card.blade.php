<div onclick="location.assign('/{{$notification->data['data']['url']}}');"
    ...
    <div class="notifications-card d-flex w-100 justify-content-between flex-wrap">
        <div>
            ...
            @switch($notification->data['type'])
                @case("Follow")
                <a href="" class="pb-1"><img class="rounded-circle pr-1" width="36px" heigth="36px"
                                             src="{{$notification->data['data']['follower_picture']}}">{{$notification->data['data']['follower_name']}}
                </a>
                ...
                @case("Question")
                <a href="" class="pb-1"><img class="rounded-circle pr-1" width="36px" heigth="36px"
                                             src="{{$notification->data['data']['following_picture']}}">{{$notification->data['data']['following_name']}}
                </a>
                ...
                <span class="text-muted"> left a comment on your @if($notification->data['data']['type']=="Answer")
                        answer to the @endif question: </span>
