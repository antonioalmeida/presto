 <div onclick="location.assign('/{{$notification->data['data']['url']}}');"  class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="notifications-card d-flex w-100 justify-content-between flex-wrap">
                                <div>
                                    ...
                                    @switch($notification->data['type'])
                                        @case("Follow")
                                            <a href="" class="pb-1"><img class="rounded-circle pr-1" width="36px" heigth="36px" src="{{$notification->data['data']['follower_picture']}}">{{$notification->data['data']['follower_name']}}</a>
                                    <span class="text-muted"> started following you.</span>
                                            @break

                                        @case("Question")
                                        <a href="" class="pb-1"><img class="rounded-circle pr-1" width="36px" heigth="36px" src="{{$notification->data['data']['following_picture']}}">{{$notification->data['data']['following_name']}}</a>
