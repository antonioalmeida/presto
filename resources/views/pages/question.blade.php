                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="ml-3">
                                    <a href="" class="btn btn-sm btn-primary"><span class="text-mobile"><i class="far fa-user-times"></i></span> <span class="text-collapse"><i class="far fa-user"></i> Following</span></a>
                                </div>
                            </div>
                            ...
                            <div class="card my-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex list-group list-group-flush short-padding">
                                        ...
                                        <a class="btn btn-lg btn-link text-dark" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2">
                                            View More
                                        </a>
                                    </div>
                                </div>
